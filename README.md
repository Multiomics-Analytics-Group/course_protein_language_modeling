...
|              | **Protein Design**          | [Protein Design Notebook](prot_design.ipynb)  | *De novo* protein design and engineering using a LLM |     [ProtGPT2](https://huggingface.co/nferruz/ProtGPT2) and [ESM](https://github.com/facebookresearch/esm)            |
